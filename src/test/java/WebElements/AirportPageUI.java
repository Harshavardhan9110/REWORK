...
public class AirportPageUI {
	...
	//here i used CssSelectors to find the path and rest of them  i used xpath because elements are not locating to the cirrect path
	public static By airport=By.cssSelector("*[href='/airport-taxi']");
	public static By src=By.cssSelector("*[id='fromCityList']");
